...
$orphanage_id = $_GET['orphanage_id'];
    ...
    $query = "SELECT child_id from for_foster WHERE orphanage_id=$orphanage_id AND fostered=1";
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <ul class="list-inline">
                                    <li class="causes-raised">CHILDERN TO FOSTER: <?php echo $row_cnt1?></li>
                                    <li class="causes-goal">IN FOSTERCARE: <?php echo $row_cnt?></li>
                                </ul>
                                <div style="margin-top:20px;">
                                    <div class="pull-left">
                                        <a class="thm-btn btn-xs" data-toggle="modal" href="#modal-donate-now">Donate Now</a>
                                        <a class="thm-btn inverse btn-xs"
                                            href="foster_childrens.php?orphanage_id=<?php echo $orphanage_id?>">Children
                                            List</a>
                                    </div>
                                </div>
                            </div>
