...
<header class="header">
    <div class="container">
        <div class="logo pull-left" style="padding-top:8px;">
            <a href="foster_home.php" style="font-weight:700;font-family:rubik;color:black;font-size:26px;">FOSTER<span
        ...
        <div class="header-right-info pull-right clearfix">
            ...
            <div class="single-header-info">
                <div class="dropdown">
                    <a><img src="./img/foster/<?php echo $image?>" alt="" height="40" style="border-radius:50%;">
                    ...
                    <div class="dropdown-content">
                        <a href="foster_profile.php">My Profile</a>
    ...
    <div class="container">
        <div class="navigation pull-left">
            <div class="nav-header">
                ...
                <ul>
                    <li><a href="foster_home.php">Home</a></li>
                    <li><a href="foster_appointments.php">My Appointments</a></li>
                    <li><a href="foster_orphanages.php">Orphanages</a></li>
                </ul>
            </div>
