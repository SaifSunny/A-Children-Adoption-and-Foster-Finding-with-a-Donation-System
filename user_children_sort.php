		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 pull-left">
					...
					<?php
                        $sql = "SELECT * FROM for_adoption WHERE orphanage_id='$orphanage_id' AND adopted=0 AND age BETWEEN $min_age AND $max_age";
					...
					<div class="col-md-6" >
						<div class="single-blog-post">
							<div class="img-box">
								<a href="user_children_details.php"><img src="img/children/<?php echo $child_img?>" alt="" width="350px"></a>
							</div>
							<div class="content-box">
								...
								<div class="content">
									<a href="user_children_details.php">
				...
				<div class="col-md-4 pull-right">
					<div class="side-bar-widget">
						...
						<div class="single-sidebar-widget category">
							...
							<ul>
								<li><a href="user_children_sort.php?orphanage_id=<?php echo $orphanage_id?>&age=2">0-2 Years</a></li>
								<li><a href="user_children_sort.php?orphanage_id=<?php echo $orphanage_id?>&age=4">2-4 Years</a></li>
								<li><a href="user_children_sort.php?orphanage_id=<?php echo $orphanage_id?>&age=6">4-6 years</a></li>
								<li><a href="user_children_sort.php?orphanage_id=<?php echo $orphanage_id?>&age=8">6-8 Years</a></li>
								<li><a href="user_children_sort.php?orphanage_id=<?php echo $orphanage_id?>&age=10">8-10 Years</a></li>
							</ul>
						</div>
