            ...
            <div class="row">
                <?php
                        ...
                        if($result){
                            while($row=mysqli_fetch_assoc($result)){
                                ...
                                $query1 = "SELECT child_id from for_foster WHERE orphanage_id=$orphanage_id AND fostered=0";
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="causes sm-col5-center">
                        <div class="thumb">
                            <a href="foster_orphanage_details.php?orphanage_id=<?php echo $orphanage_id?>"><img class="full-width" alt="" src="img/orphanages/<?php echo $orphanage_img?>"></a>
                        </div>
                        <div class="causes-details clearfix">
                            <h4 class="title"><a href="foster_orphanage_details.php?orphanage_id=<?php echo $orphanage_id?>"><?php echo $orphanage_name?></a></h4>
                            <ul class="about-causes list-inline clearfix">
                                <li class="causes-goal" style="padding-right:10px;">Dhaka</li>
                                <li class="causes-goal">CHILDERN TO FOSTER: <?php echo $row_cnt1?></li>
                            </ul>
                            <p><?php echo substr($about, 0, 183);?></p>
                            <div>
                                <a href="foster_childrens.php?orphanage_id=<?php echo $orphanage_id?>" class="thm-btn btn-xs">Foster Now</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 promote-project text-center">
                    ...
                    <p>To implement a community-involved effort to care for orphaned, abandoned, and vulnerable babies and young children. Ensure every needy child is reached and has access to all their basic needs, including but not limited to education, health, shelter, food, and clothing.
