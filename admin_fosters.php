        ...
        <div class="row" style="margin-bottom:60px;">
          <div class="col-md-12">
            <div class="card mx-auto"
              ...
              <h2 style="padding:30px;color:black;">Manage Fosters</h2>
              <div class="butt" style="text-align:right; padding-right:70px; padding-bottom:40px;">
                <a href="admin_add_foster.php" class="btn btn-success">Add Fosters</a>
                <a href="admin_verify_foster.php" class="btn btn-primary">Verify Fosters</a>
              </div>
              <div class="card-body text-center" style="padding:0 60px;">
                <table class="table" style="font-size: 14px;color:#222;">
                  ...
                  <?php 
                    ...
                    ?>
                    <tr>
                      <td><img src="./img/foster/<?php echo $image?>" style="width:60px;border-radius: 20%;"
                      ...
                      <td><a href="admin_delete_foster.php?id=<?php echo $id ?>" class="btn btn-danger">Delete</a>
                      </td>
