            ...
            <div class="card mx-auto"
              ...
              <div class="card-body text-center" style="padding:0 60px;">
                <table class="table" style="font-size: 14px;">
                  ...
                  <tbody>
                    <?php 
                      $sql = "SELECT * FROM foster_meetings WHERE `foster_id`= $foster_id";
                      $result = mysqli_query($conn, $sql);
                      if($result){
                        while($row=mysqli_fetch_assoc($result)){
                          ...
                          $sql1 = "SELECT * FROM `orphanage` WHERE orphanage_id='$orphanage_id'";
                    ...
                    <tr>
                      ...
                      <td>
                      <a href="foster_appointment_update.php?id=<?php echo $meeting_id?>" class="btn btn-success">Update</a>
                      <a href="foster_delete_appointment.php?id=<?php echo $meeting_id?>" class="btn btn-danger">Delete</a>
                      </td>
