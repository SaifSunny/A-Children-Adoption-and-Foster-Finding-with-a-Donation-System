      ...
      <div class="row" style="margin-bottom:60px;">
        <div class="col-md-12">
          <div class="card mx-auto"
            ...
            <h2 style="padding:30px;color:black;">Manage Users</h2>
              ...
              <table class="table" style="font-size: 14px;color:#222;">
                ...
                <tbody>
                  <?php 
                    ...
                    ?>
                  <tr>
                    <td><img src="./img/users/<?php echo $image?>" style="width:60px;border-radius: 20%;" alt="profile">
                    ...
                    <td><a href="admin_delete_user.php?id=<?php echo $id ?>" class="btn btn-danger">Delete</a>
                    </td>
