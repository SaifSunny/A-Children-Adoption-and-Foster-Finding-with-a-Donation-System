      ...
      <div class="row" style="margin-bottom:90px;">
        <div class="col-md-12">
          <div class="card mx-auto"
            ...
            <h4 style="padding:30px;">For Foster</h4>
            <div class="butt" style="text-align:right; padding-right:70px; padding-bottom:40px;">
              <a href="orphanage_foster_add_child.php" class="btn btn-success">Add for Foster</a>
            </div>
              ...
              <table class="table" style="font-size: 14px;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="orphanage_foster_success.php?id=<?php echo $child_id?>" class="btn btn-success">Successfull</a>
                      <a href="orphanage_delete_childfoster.php?id=<?php echo $child_id?>" class="btn btn-danger">Delete</a>
                    </td>
