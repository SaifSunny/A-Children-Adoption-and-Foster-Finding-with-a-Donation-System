...
if(isset($_POST['submit'])){
    ...
    $message = $_POST['message'];
        ...
        if(!$query_run->num_rows > 0){
            $query2 = "UPDATE adoption_meetings SET `date`='$date', `time`='$time', `message`='$message', contact='$contact', email='$email'";
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input name="date" id="date" type="date" class="form-control" placeholder="dd/mm/yyyy" value="<?php echo $date?>" required>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  ...
                  <label for="time">Meeting Time</label>
                    <input name="time" id="time" type="time" class="form-control" placeholder="Time" value="<?php echo $time?>" required>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                ...
                <div class="col-lg-6">
                  ...
                  <label for="contact">Contact No.</label>
                    <input name="contact" id="contact" type="Number" class="form-control" placeholder="Contact Number" value="<?php echo $contact?>"
                    required>
                  </div>
                </div>
              </div>
