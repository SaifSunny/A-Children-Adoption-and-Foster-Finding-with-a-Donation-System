        ...
        <div class="col-md-12">
          <div class="card mx-auto"
            ...
            <div style="padding-top:50px;">
              <a href="admin_orphanage_verification.php?id=<?php echo $orphanage_id ?>" class="btn btn-success"
                style="padding:10px;">Verify</a>
              <a href="admin_delete_orphanage.php?id=<?php echo $orphanage_id ?>" class="btn btn-danger"
