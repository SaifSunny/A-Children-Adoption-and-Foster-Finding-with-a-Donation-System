...
if(isset($_POST['submit'])){
  ...
  $extensions_arr = array("jpg","jpeg","png","gif");
          ...
          $query = "SELECT * FROM for_adoption WHERE child_name = '$childname' AND background = '$background'";
          ...
          if(!$query_run->num_rows > 0){
              ...
              if( in_array($imageFileType,$extensions_arr) ){
                  ...
                  if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                      ...
                      $query2 = "INSERT INTO for_adoption(orphanage_id ,orphanage_name,`child_img`,child_name,age,gender,birthday,background, `religion`, hobby, post_date)
                      VALUES ('$orphanage_id', '$orphanage_name', '$name', '$childname', '$age', '$gender', '$birthday', '$background', '$religion', '$hobby', '$post_date')";
                      $query_run2 = mysqli_query($conn, $query2);
          
                      if ($query_run2) {
                          $cls="success";
                          $error = "Child Successfully Added for Adoption.";
                      } 
                      else {
                          $cls="danger";
        ...
        <div class="row" style="padding-top:30px;margin-bottom:90px;color:#222">
          ...
          <div class="col-md-8">
            ...
            <div class="card mx-auto"
              ...
              <h4 class="card-title">For Adoption</h4>
              <div class="card-body" style="padding:0 60px;">
                ...
                <div class="d-flex justify-content-end" style="padding-top:20px;">
                  <button type="submit" name="submit" class="btn btn-success" style="margin-right:10px;"><i
                      class="fas fa-plus-square"></i>&nbsp;&nbsp;Put for Adoption</button>
