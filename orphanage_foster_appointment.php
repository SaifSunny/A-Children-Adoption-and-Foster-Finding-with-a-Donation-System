            ...
            <div class="row" style="margin-bottom:90px;">
                <div class="col-md-12">
                    <div class="card mx-auto"
                        ...
                        <h4 style="padding:30px;">Foster Meetings</h4>
                        <div class="card-body text-center" style="padding:0 60px;">
                            <table class="table" style="font-size: 14px;">
                                ...
                                <tbody>
                                    <?php 
                                    $sql = "SELECT * FROM foster_meetings WHERE `orphanage_id`= $orphanage_id";
                                    $result = mysqli_query($conn, $sql);
                                    if($result){
                                    ...
                                    ?>
                                    <tr>
                                        <td><img src="./img/children/<?php echo $child_img ?>"
                                                style="width:50px;border-radius: 20%;" alt="profile"> <span
                                                style="padding-left:20px;"></span></td>
                                        <td><?php echo $child_name ?></td>
                                        <td><?php echo $foster_name ?></td>
                                        <td><?php $part = explode('-', $date); echo $part[2]."-".$part[1]."-".$part[0]?>
                                        </td>
                                        <td><?php echo $time ?></td>
                                        <td><?php echo $contact ?></td>
                                        <td><?php echo $message ?></td>
                                        <td><a href="foster_adoption_meeting_update.php?id=<?php echo $meeting_id?>"
                                                class="btn btn-success">Update</a>
                                                <a href="orphanage_delete_appointment.php?id=<?php echo $meeting_id?>"
