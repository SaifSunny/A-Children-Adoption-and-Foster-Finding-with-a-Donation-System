            ...
            <div class="row" style="margin-bottom:90px;">
                <div class="col-md-12">
                    <div class="card mx-auto"
                        ...
                        <h4 style="padding:30px;">Adoption Appointments</h4>
                        <div class="card-body text-center" style="padding:0 60px;">
                            <table class="table" style="font-size: 14px;">
                                ...
                                <tbody>
                                    <?php 
                                    $sql = "SELECT * FROM adoption_meetings WHERE `orphanage_id`= $orphanage_id";
                                    $result = mysqli_query($conn, $sql);
                                    if($result){
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="orphanage_adoption_meeting_update.php?id=<?php echo $meeting_id?>"
