...
if (isset($_POST['submit_img'])) {
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
            ...
            // Convert to base64 
            $image_base64 = base64_encode(file_get_contents('img/foster/'.$name));
            $image = 'data:img/'.$imageFileType.';base64,'.$image_base64;

            // Update Record
            $query2 = "UPDATE foster SET `foster_img`='$name' WHERE username='$username'";
...
if (isset($_POST['submit_nid'])) {
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
            ...
            // Convert to base64 
            $image_base64 = base64_encode(file_get_contents('img/nid/'.$name));
            $image = 'data:img/'.$imageFileType.';base64,'.$image_base64;

            // Update Record
            $query2 = "UPDATE foster SET `nid_img`='$name' WHERE username='$username'";
            $query_run2 = mysqli_query($conn, $query2);

            if ($query_run2) {
                $cls="success";
                $error = "NID Successfully Submitted.";
            } 
            else {
                $cls="danger";
                $error = "Cannot Update Profile Image";
...
if (isset($_POST['submit'])) {
    ...
    $cls="";
        ...
        // Update Record
        $query2 = "UPDATE foster SET firstname='$firstname',lastname='$lastname',
        birthday='$birthday', nid='$nid', gender='$gender', contact='$contact',
...
<body>
    ...
    <section class="blog-home blog-page">
        <div class="container">
            <div class="row" style="padding-top:30px;margin-bottom:60px;">
                <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12" style="width: 200px; height: 200px;">
                                            <img src="./img/foster/<?php echo $image ?>" width="100%" height="100%"
                        ...
                        <div class="card-body">
                            <form action="" method="POST" enctype='multipart/form-data' style="margin-bottom:30px;">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12" style="padding-top:20px;">
                                            <label for="file" class="form-label">NID Image</label>
                                            <div class="d-flex justify-content-center"
                                                style="padding-top:10px; padding-left:30px;">
                                                <input type="file" name="file" id="file" style="padding-left:40px;">
                                            ...
                                            <div class="d-flex justify-content-center" style="padding-top:10px;">
                                                <button type="submit_nid" name="submit_nid" class="btn btn-success"
                                                    style="margin-top:10px;"><i class="fa fa-edit"></i> Update
                                                    Image</button>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                        <div class="form-group" style="padding:10px">
                                            ...
                                            <input type="text" class="form-control" name="nid" id="nid"
                                                value="<?php echo $nid ?>" placeholder="NID No." required>
