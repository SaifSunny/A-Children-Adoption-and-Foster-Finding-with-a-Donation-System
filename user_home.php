        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 pull-left"
                    ...
                    <div class="side-bar-widget">
                        <div class="single-sidebar-widget popular-post">
                            ...
                            <ul>
                            <?php 
                                $sql = "SELECT * FROM adoption_meetings WHERE `user_id`= $uid ORDER by meeting_id DESC";
                                $result = mysqli_query($conn, $sql);
                                if($result){
                        ...
                        <div style="text-align:center">
                                <a href="user_appointments.php" style="font-weight:700; margin-top:50px">See All</a>
                            </div>
                    </div>
                ...
                <div class="col-md-5 pull-right"
                    ...
                    <div class="side-bar-widget">
                        <div class="single-sidebar-widget popular-post">
                            <h3 class="title">Adoption Process</h3>
                            <hr>
                            <ul>
                                <li>
                                    <div class="content-box" style="font-weight:700;">
                                        <span>1. Browse through our website to find children you would like to
                                            adopt.</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="content-box" style="font-weight:700;">
                                        <span>2. Set up a meeting with the orphanage to meet the children you want to
                                            adopt.</span>
                                ...
                                <li>
                                    <div class="content-box" style="font-weight:700;">
                                        <span>3. Visit the orphanage at the scheduled time and spend time with the
                                            children.</span>
                                ...
                                <li>
                                    <div class="content-box" style="font-weight:700;">
                                        <span>4. If you are happy with your choice, the orphanage will visit your home
                                            with your approved child.</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="content-box" style="font-weight:700;">
                                        <span>5. Then, you will be asked to complete all the necessary forms to complete
                                            the adoption.</span>
                                    </div>
                                </li>
                            </ul>
