      ...
      <div class="row" style="margin-bottom:60px;">
        <div class="col-md-12">
          <div class="card mx-auto"
            ...
            <h2 style="padding:30px;color:black;">Donations</h2>
              ...
              <table class="table" style="font-size: 14px;color:#222;">
                ...
                <tbody>
                  <?php 
                    ...
                    $sql2 = "SELECT SUM(donation_amount) as total FROM donations";
                    ...
                    if($result){
                      ...
                      $date=$row['date'];
                      $donation_reciever_id=$row['donation_reciever_id'];
                      

                      $sql5 = "SELECT * FROM orphanage WHERE orphanage_id='$donation_reciever_id'";
                      $result5 = mysqli_query($conn, $sql5);
                      $row5=mysqli_fetch_assoc($result5);

                      $orphanage_name=$row5['orphanage_name'];
