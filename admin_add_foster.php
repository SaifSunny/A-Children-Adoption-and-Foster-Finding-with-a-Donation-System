...
if(isset($_POST['submit'])){
    ...
    if (strlen($p) > 5) {
        ...
        $query = "SELECT * FROM foster WHERE username = '$username'";
        $query_run = mysqli_query($conn, $query);
        if (!$query_run->num_rows > 0) {

            $query = "SELECT * FROM foster WHERE username = '$username' AND email = '$email'";
            $query_run = mysqli_query($conn, $query);
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        $query2 = "INSERT INTO foster(username ,email,`password`,firstname,lastname,contact,gender,birthday,foster_img, `address`, city, zip, nid)
                        VALUES ('$username', '$email', '$password', '$firstname', '$lastname', '$contact', '$gender', '$birthday', '$name', '$address', '$city', '$zip', '$nid')";
                        $query_run2 = mysqli_query($conn, $query2);
            
                        if ($query_run2) {
                            $cls="success";
                            $error = "foster Successfully Added.";
                        } 
                        else {
                            $cls="danger";
        ...
        <div class="row" style="padding-top:30px;margin-bottom:90px;">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-12" style="width: 200px; height: 200px;">
                      <img src="./img/foster/user.png" width="100%" height="100%"
          ...
          <div class="col-md-8">
            ...
            <div class="card mx-auto"
              ...
              <h4 class="card-title">Add foster</h4>
              <div class="card-body" style="padding:0 60px;">
                ...
                <div class="d-flex justify-content-end" style="padding-top:20px;">
                  <button type="submit" name="submit" class="btn btn-success" style="margin-right:10px;"><i
                    ...
                    foster</button>
                  <a href="admin_fosters.php" class="btn btn-primary">Go Back</a>
                </div>
