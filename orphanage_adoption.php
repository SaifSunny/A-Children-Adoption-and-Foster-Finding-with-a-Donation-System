      ...
      <div class="row" style="margin-bottom:90px;">
        <div class="col-md-12">
          <div class="card mx-auto"
            ...
            <h4 style="padding:30px;">For Adoption</h4>
            <div class="butt" style="text-align:right; padding-right:70px; padding-bottom:40px;">
                <a href="orphanage_adoption_add_child.php" class="btn btn-success">Add for Adoption</a>
              </div>
              ...
              <table class="table" style="font-size: 14px;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="orphanage_adoption_success.php?id=<?php echo $child_id?>" class="btn btn-success" style="margin-bottom:10px;">Successfull</a>
                      <a href="orphanage_delete_childadoption.php?id=<?php echo $child_id?>" class="btn btn-danger">Delete</a>
                    </td>
