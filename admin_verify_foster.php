          ...
          <div class="card mx-auto"
            ...
            <div class="card-body text-center" style="padding:0 60px;">
              <table class="table" style="font-size: 14px;color:#222;">
                ...
                <tbody>
                  <?php 
                      $sql = "SELECT * FROM foster WHERE `verified`='0'";
                      $result = mysqli_query($conn, $sql);
                      if($result){
                  ...
                  <tr>
                    <td><img src="./img/foster/<?php echo $image ?>" style="width:80px;border-radius: 20%;"
                    ...
                    <td>
                      <a href="admin_foster_nid.php?id=<?php echo $id ?>" class="btn btn-success"
                      style="margin-bottom:8px;">View</a>
                    </td>

                    <td>
                      <a href="admin_foster_verification.php?id=<?php echo $id ?>" class="btn btn-success"
                        >Verify</a>
                      <a href="admin_delete_foster.php?id=<?php echo $id ?>" class="btn btn-danger"
                        style="padding:4px;">Delete</a>
                    </td>
                  </tr>
                  <?php 
                        }
