...
$sql = "SELECT * FROM `foster_meetings` WHERE meeting_id='$meeting_id'";
$result = mysqli_query($conn, $sql);
$row=mysqli_fetch_assoc($result);
...
if(isset($_POST['submit'])){
  ...
  $message = $_POST['message'];
      ...
      if(!$query_run->num_rows > 0){
          $query2 = "UPDATE foster_meetings SET `date`='$date', `time`='$time', `message`='$message', contact='$contact', email='$email'";
